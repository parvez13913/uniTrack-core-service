-- CreateTable
CREATE TABLE "acamemic_semesters" (
    "id" TEXT NOT NULL,
    "year" TEXT NOT NULL,
    "title" TEXT NOT NULL,
    "code" TEXT NOT NULL,
    ...
    CONSTRAINT "acamemic_semesters_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "students" ADD CONSTRAINT "students_academicSemesterId_fkey" FOREIGN KEY ("academicSemesterId") REFERENCES "acamemic_semesters"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
